...
if __name__ == "__main__":
    ...
    tmplt = templateEnv.get_template('calibrator.html')

    band_6 = amapola.get_recent_values(calibrator_name="J1331+3030 ", freq_ghz=233, lookback_days=180)
    band_7 = amapola.get_recent_values(calibrator_name="J1331+3030 ", freq_ghz=343.45, lookback_days=180)
